...
export interface StreamingConfig {
  requiresWordBoundaries: boolean
  lookaheadBytes: number
  canEmitIncrementally: boolean
  minChunkSize: number
}
...
export declare class StreamingTokenizer {
  constructor(model: Model, bufferSize?: number | undefined | null)
  processChunk(chunk: Buffer): void
  finalize(): void
  drainTokens(): Array<StreamingToken>
